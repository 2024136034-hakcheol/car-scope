...
import { collection, addDoc, deleteDoc, doc, query, orderBy, onSnapshot, writeBatch, collectionGroup, where, increment, getDocs } from 'firebase/firestore';
        ...
        <div className="admin-widget widget-full">
            ...
            <div style={{marginBottom: '30px', padding: '20px', backgroundColor: '#f8f9fa', borderRadius: '12px'}}>
                ...
                <form onSubmit={handleCreate} style={{display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '15px', alignItems: 'end'}}>
                    ...
                    <div className="input-group" style={{marginBottom: 0}}>
                        <label style={{whiteSpace: 'nowrap'}}>사용 한도설정</label>
                        <div style={{
                            display: 'flex', 
                            alignItems: 'center', 
                            height: '42px', 
